...
extension RemotePayloadCopyTests {
    ...
    struct RemoteRangeTransferTests {
        ...
        @Test func redirectPolicyPermanentlyStripsAuthorizationAfterHostChange() throws {
            ...
            let sourceResponse = try #require(
                HTTPURLResponse(
                    url: sourceURL,
                    statusCode: 302,
                    httpVersion: nil,
            ...
            let storageResponse = try #require(
                HTTPURLResponse(
                    url: storageURL,
                    statusCode: 302,
                    httpVersion: nil,
        ...
        private func rangeRequest(length: Int) throws -> URLRequest {
            ...
            let url = try #require(
                URL(string: "https://hf.test/owner/model/resolve/\(commit)/file.bin"))
