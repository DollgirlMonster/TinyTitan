...
@Suite struct PrefillRoutedTileSchedulerTests {
    ...
    @Test func schedulerConfigValidatesSlotBudget() {
        ...
        let depthTwoFourExperts = PrefillRoutedTileSchedulerConfig(
            maxPendingDepth: 2, tileExperts: 4)
        let depthTwoEightExperts = PrefillRoutedTileSchedulerConfig(
            maxPendingDepth: 2, tileExperts: 8)
    ...
    @Test func schedulerConfigShrinksTilesForEightSlotStreamingCache() {
        ...
        #expect(
            fitted
                == PrefillRoutedTileSchedulerConfig(
                    maxPendingDepth: 1,
                    tileExperts: 4))
