...
/// `com.tinytitan.decode.<uid>.<owner-pid>.<token>`. That makes the rule simple and
...
enum DecodeServiceJobSweep {
    static let labelPrefix = "com.tinytitan.decode."
    ...
    static func parseLaunchctlList(_ output: String, uid: uid_t) -> [Job] {
        output.split(separator: "\n").compactMap { line in
            ...
            guard parts.count == 6,
                  parts[0] == "com", parts[1] == "tinytitan", parts[2] == "decode",
                  parts[3] == String(uid),
