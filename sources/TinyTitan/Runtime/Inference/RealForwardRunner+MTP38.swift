...
extension RealForwardRunner {
    ...
    func advanceMTP38(
        ...
        try encodeFusion(
            commandBuffer: cb, rows: tokens.count,
        ...
        return try await runDraftLayer(
            tokens: tokens,
            startPosition: startPosition,
            predictNext: predictNext,
            fused: projected)
