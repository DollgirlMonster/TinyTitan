...
final class RMSNorm {
    ...
    init(context: MetalContext) throws {
        ...
        self.psoBF16D2816 = try Self.specializedPipeline(
            context,
            "rmsnorm_bf16w",
            d: 2816)
        self.psoNoScaleD2816 = try Self.specializedPipeline(
            context,
            "rmsnorm_no_scale",
            d: 2816)
        self.psoBF16PerHead256 = try Self.specializedPipeline(
            context,
            "rmsnorm_bf16w_perhead",
            d: 256)
        self.psoBF16PerHead512 = try Self.specializedPipeline(
            context,
            "rmsnorm_bf16w_perhead",
            d: 512)
        self.psoNoScalePerHead256 = try Self.specializedPipeline(
            context,
            "rmsnorm_no_scale_perhead",
            d: 256)
        self.psoNoScalePerHead512 = try Self.specializedPipeline(
            context,
            "rmsnorm_no_scale_perhead",
            d: 512)
    }
    ...
    private func perHeadPipeline(
        headDim: UInt32,
        base: MTLComputePipelineState,
        p256: MTLComputePipelineState,
        p512: MTLComputePipelineState
