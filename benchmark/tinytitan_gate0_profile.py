...
profile from `tinytitan_profile` with `TINYTITAN_RUNNER_STATS=1` and
`TINYTITAN_KERNEL_STATS=1`, replays the published continuous-prose workload, and
...
Usage:
  python3 benchmark/tinytitan_gate0_profile.py                 # both quantizations
